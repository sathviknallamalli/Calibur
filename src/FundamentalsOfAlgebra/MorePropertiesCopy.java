...
public class MorePropertiesCopy extends JFrame {
	public MorePropertiesCopy() {
		...
		JLabel lblinOrderFor = new JLabel(
				"<html>When solving equations you may want to re arrange the way the equation looks to make it easier. There are some properties that allow you to do so and have the same equation\r\n");
		...
		lblAssociativePropertyab.setBounds(227, 161, 249, 16);
		...
		JLabel lbltheAdditionProperty = new JLabel(
				"<html>This property allows you to swap arround things next to the equals sign to put it into standard form. The STANDARD FORM of AN ANSWER is to have the VARIABLE ON THE LEFT SIDE OF THE EQUALS SIGN, AND THE NUMBER ON THE RIGHT SIDE. \r\n");
		lbltheAdditionProperty.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lbltheAdditionProperty.setBounds(227, 179, 388, 78);
		...
		lblSubbtractionPropertyOf.setBounds(612, 154, 249, 16);
		getContentPane().add(lblSubbtractionPropertyOf);

		JLabel lbltheSubbtractionProperty = new JLabel(
				"<html>Remember if you can set anything equal to itsef. You can use this property to do so");
		lbltheSubbtractionProperty.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lbltheSubbtractionProperty.setBounds(612, 174, 347, 42);
		...
		lblexampleARemember.setBounds(227, 258, 318, 23);
		...
		lblIfXy.setBounds(227, 281, 318, 23);
		...
		lblOrderOfEquality.setBounds(227, 303, 318, 23);
		...
		lblForAllReal.setBounds(612, 215, 318, 23);
		...
		lblANumberEquals.setBounds(612, 241, 318, 23);
		...
		lblTransitiveProperty.setBounds(21, 329, 128, 16);
		getContentPane().add(lblTransitiveProperty);

		JLabel lblifYouKnow = new JLabel(
				"<html>If you know that two things are equal to each other, and another variable is equal to one of those two, that means that it will also equal the 2nd variable in the first statement");
		lblifYouKnow.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lblifYouKnow.setBounds(21, 347, 997, 23);
		...
		lblForAllReal_1.setBounds(21, 373, 318, 23);
		...
		lblIfXyAnd.setBounds(21, 396, 318, 23);
		getContentPane().add(lblIfXyAnd);

		JLabel lblInALiteral = new JLabel(
		...
		lblInALiteral.setBounds(324, 368, 412, 64);
		...
		btnTakeTheLesson.setBounds(785, 440, 215, 36);
		...
		label.setBounds(762, 419, 256, 16);
