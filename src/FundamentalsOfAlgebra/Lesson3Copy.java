...
public class Lesson3Copy extends JFrame {
	public Lesson3Copy() {
		...
		JLabel lblNewLabel = new JLabel(
				"Natural Numbers - In short, these are basically the positive counting numbers\r\n");
		...
		JLabel lblRationalNumbers = new JLabel(
				"Rational Numbers - All of the above numbers including repeating and terminating decimals");
		...
		JLabel lblIrrationalNumbers = new JLabel(
				"Irrational Numbers - Ususally decimals that go on forever and dont repeat ");
		...
		JLabel lblallOfThese = new JLabel(
				"<html>All of these types of numbers come under 1 single set of REAL NUMBERS. Likewise, there is another set called IMAGINARY NUMBERS too.");
