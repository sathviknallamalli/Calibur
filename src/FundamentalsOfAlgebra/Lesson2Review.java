...
public class Lesson2Review extends JFrame {
	...
	public Lesson2Review() {
		...
		JLabel lblWhichOf = new JLabel(
				"7.) Solve the following equation using the Distributive Property:  4(x+3) = 12\r\n");
		...
		JLabel lblAcoordingTo = new JLabel(
				"<html>8.) Acoording to the transitive property what is the value of B: if   9a-12 = 6 AND a=c AND c=B\r\n");
		...
		boolean exists = TACALIBUR.startCourseVerify("Fundamentals of Algebra: Lesson 2 Review");
		if (exists == true) {
			TACALIBUR.scoreShow(bs, "Fundamentals of Algebra: Lesson 2 Review");
		}
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				next.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						TACALIBUR.lessonComplete("Fundamentals of Algebra: Lesson 2 Review", score);
