...
public class HWHELP {
	...
	private void initialize() {
		...
		btnFormulasPage.setBounds(317, 450, 174, 23);
		...
		lblUnitCircle.setBounds(20, 147, 219, 64);
		frame.getContentPane().add(lblUnitCircle);

		JButton btnUnitCircle = new JButton("Unit Circle\r\n");
		btnUnitCircle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		...
		btnUnitCircle.setBounds(43, 217, 174, 23);
		...
		lbltrigonometricFunction.setBounds(20, 251, 219, 80);
		...
		btnTrigTable.setBounds(43, 336, 174, 23);
		...
		lblprimeNumbersCan.setBounds(20, 365, 219, 47);
		...
		button.setBounds(43, 416, 174, 23);
		...
		btnPeriodicTable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String website = "http://www.ptable.com/";
				try {
		...
		JLabel lblsincePhysicsIs = new JLabel(
				"<html>Since physics is an engineering subject, you can view simulations at this link and learn more");
		lblsincePhysicsIs.setForeground(Color.BLUE);
		lblsincePhysicsIs.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblsincePhysicsIs.setBackground(new Color(0, 204, 0));
		lblsincePhysicsIs.setBounds(244, 251, 167, 72);
		frame.getContentPane().add(lblsincePhysicsIs);

		JButton btnPhsyicsClassroom = new JButton("Phsyics Classroom\r\n");
		btnPhsyicsClassroom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String[] arguments = { "1", "2", "3" };
				String website = "http://www.physicsclassroom.com/";
				try {
					Browser.main(arguments, website);
				} catch (IOException e1) {
					e1.printStackTrace();
		...
		btnPhsyicsClassroom.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		btnPhsyicsClassroom.setBounds(244, 323, 174, 23);
		frame.getContentPane().add(btnPhsyicsClassroom);

		JLabel lblsomeKeyConversion = new JLabel(
				"<html>Some key conversion factors can be found at this link and will help you in various problems");
		lblsomeKeyConversion.setForeground(Color.BLUE);
		lblsomeKeyConversion.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblsomeKeyConversion.setBackground(new Color(0, 204, 0));
		lblsomeKeyConversion.setBounds(615, 179, 167, 72);
		frame.getContentPane().add(lblsomeKeyConversion);

		JButton btnConversionFactors = new JButton("Conversion Factors\r\n");
		btnConversionFactors.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String[] arguments = { "1", "2", "3" };
				String website = "https://www.wyzant.com/resources/lessons/math/elementary_math/measurement";
				try {
					Browser.main(arguments, website);
				} catch (IOException e1) {
					e1.printStackTrace();
		...
		btnConversionFactors.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		btnConversionFactors.setBounds(615, 251, 159, 23);
		frame.getContentPane().add(btnConversionFactors);

		JButton btnKhanAcademy = new JButton("Khan Academy");
		btnKhanAcademy.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String[] arguments = { "1", "2", "3" };
				String website = "https://www.khanacademy.org/";
				try {
					Browser.main(arguments, website);
				} catch (IOException e1) {
		...
		btnKhanAcademy.setBackground(Color.ORANGE);
