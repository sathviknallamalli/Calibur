...
public class Dup extends JFrame {
	...
	public Dup() {
		...
		pic.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Certificates\\MachinesCer.PNG"));
		...
		JLabel lbltheNextCourse = new JLabel(
				"<html>The next course is Magnetism. In this course you will learn about how magnets work and the practical applications about these wonderful creations. Topics such as poles, forces, and real world uses will all be talked about in this chapter.");
