...
public class Lesson1 extends JFrame {
	public Lesson1() {
		...
		JLabel title = new JLabel("Lesson 1 - Simple Machines");
		...
		JCheckBox l4 = new JCheckBox("Lesson 4 - Evaluating Machines");
		l4.setForeground(Color.RED);
		l4.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		l4.setEnabled(false);
		l4.setBounds(6, 155, 215, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Lesson1More l1 = new Lesson1More();
				l1.newClass();
				close();
			}
		});
		...
		JCheckBox chckbxLesson = new JCheckBox("Lesson 5 - Energy & Machines\r\n");
		...
		chckbxLesson.setBounds(6, 181, 215, 23);
		...
		JCheckBox chckbxLesson_2 = new JCheckBox("Lesson 6 - Practice Problems\r\n");
		...
		chckbxLesson_2.setBounds(6, 209, 215, 23);
		...
		pic.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\wa.png"));
		pic.setBounds(265, 276, 98, 102);
		getContentPane().add(pic);

		JLabel p = new JLabel();
		p.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\pulley.png"));
		p.setBounds(405, 276, 89, 125);
		getContentPane().add(p);

		JLabel pi = new JLabel();
		pi.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\gear.png"));
		pi.setBounds(541, 276, 148, 115);
		getContentPane().add(pi);

		JLabel w = new JLabel();
		w.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\wedge.png"));
		w.setBounds(763, 276, 169, 115);
		getContentPane().add(w);
		
		JLabel l = new JLabel();
		l.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\lever.png"));
		l.setBounds(284, 425, 181, 59);
		getContentPane().add(l);

		JLabel r = new JLabel();
		r.setIcon(new ImageIcon("C:\\Users\\sathv\\Desktop\\Pics\\ramp.png"));
		...
		lbltheseAreThe.setBounds(21, 276, 215, 189);
