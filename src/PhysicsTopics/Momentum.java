...
public class Momentum extends JFrame {
	...
	public Momentum() {
		...
		JLabel title = new JLabel("Momentum");
		title.setFont(new Font("Castellar", Font.PLAIN, 25));
		title.setBounds(124, 11, 186, 42);
		...
		btnHi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Motion m = new Motion();
				String momentum = m.momentum(Double.parseDouble(v.getText()), Double.parseDouble(ma.getText()));

				mom.setText("Momentum is " + momentum);
