...
public class IdealMechanicalAdvantage extends JFrame {
	...
	public IdealMechanicalAdvantage() {
		getContentPane().setLayout(null);

		JLabel title = new JLabel("Ideal Mechanical Advantage");
		title.setFont(new Font("Castellar", Font.PLAIN, 20));
		title.setBounds(30, 11, 380, 42);
		getContentPane().add(title);

		JLabel lblNewLabel_1 = new JLabel("Enter the output length and the input length");
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.ITALIC, 12));
		lblNewLabel_1.setBounds(123, 52, 205, 14);
		getContentPane().add(lblNewLabel_1);

		JLabel mass = new JLabel("InputLength");
		...
		btnHi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double m = sm.idealMA(Double.parseDouble(ma.getText()), Double.parseDouble(v.getText()));

				mom.setText("Ideal Mechanical Advantage is " + m);
