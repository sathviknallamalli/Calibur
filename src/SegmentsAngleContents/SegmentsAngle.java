...
public class SegmentsAngle extends JFrame {

	public SegmentsAngle() {
		getContentPane().setLayout(null);

		JLabel title = new JLabel("Welcome to the Segments and Angles Course");
		title.setFont(new Font("Castellar", Font.PLAIN, 20));
		title.setBounds(108, 11, 568, 42);
