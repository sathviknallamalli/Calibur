...
public class Distance extends JFrame {
	...
	public Distance() {
		...
		JLabel title = new JLabel("Distance");
		title.setFont(new Font("Castellar",Font.PLAIN,25));
		title.setBounds(141, 11, 150, 42);
		getContentPane().add(title);
		
		JLabel info = new JLabel("Enter the two coordinates you want to find the distance of");
		info.setFont(new Font("Times New Roman",Font.ITALIC,12));
		info.setBounds(76, 50, 280, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				double d = c.distance(Double.parseDouble(x1.getText()), Double.parseDouble(y1.getText()), Double.parseDouble(x2.getText()), Double.parseDouble(y2.getText()));
				label.setText("Distance of the two coordiantes is " + d);
			}
		});
