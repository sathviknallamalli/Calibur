...
public class SphereSA extends JFrame {
	...
	public SphereSA() {
		...
		JLabel title = new JLabel("Sphere Surface Area");
		title.setFont(new Font("Castellar", Font.PLAIN, 25));
		title.setBounds(71, 11, 309, 42);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double SA = (4/3) * Math.PI * (Math.pow(r, 2)) * h;

				result.setText("The surface area of the given sphere is " + SA);
			}
		});
