...
public class ConeSA extends JFrame {
	...
	public ConeSA() {
		...
		JLabel title = new JLabel("Cone Surface Area");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double SA = ((1/3) * Math.PI * r * h) + (Math.PI * r * r);

				result.setText("The surface area of the given cone is " + SA);
			}
		});
