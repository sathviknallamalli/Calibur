	...
	public Lesson2Part2Copy() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				MorePropertiesCopy mp = new MorePropertiesCopy();
				mp.newClass();
				close();
			}
		});
		btnNewButton.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		btnNewButton.setBounds(829, 647, 215, 23);
		...
		lblAdditionPropertyOf.setBounds(255, 204, 249, 16);
		...
		lblExample.setBounds(255, 298, 318, 23);
		...
		lblGivenX.setBounds(255, 321, 318, 23);
		getContentPane().add(lblGivenX);
		
		JLabel lblsinceWeNeed = new JLabel("<html>Since we need to get x by itself, we have to move the 5 to the right side. In order to neutralize the left side we need to add 5 using Addition Property of Equality");
		lblsinceWeNeed.setForeground(Color.BLUE);
		lblsinceWeNeed.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblsinceWeNeed.setBounds(255, 347, 381, 48);
		...
		lblAdditionPropertyOf_1.setBounds(255, 399, 318, 23);
		...
		lblSimplifyX.setBounds(255, 422, 318, 23);
		...
		lblSubbtractionPropertyOf.setBounds(656, 202, 249, 16);
		getContentPane().add(lblSubbtractionPropertyOf);
		
		JLabel lblwhenIsolatingFor = new JLabel("<html>When isolating for the desired variable you may need to subbtract things off to cancel out constants or variables, the S.P.E allows you to do so.");
		lblwhenIsolatingFor.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lblwhenIsolatingFor.setBounds(656, 223, 388, 64);
		getContentPane().add(lblwhenIsolatingFor);
		
		JLabel lblsometimesYouMay = new JLabel("<html>Sometimes you may need to add values to the constants or vairables to either cancel out or make the equation easier to solve, which is done by A.P.E.");
		lblsometimesYouMay.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lblsometimesYouMay.setBounds(255, 223, 388, 64);
		...
		label_1.setBounds(655, 298, 318, 23);
		...
		lblGivenX_1.setBounds(655, 321, 318, 23);
		getContentPane().add(lblGivenX_1);
		
		JLabel lbltoIsolateFor = new JLabel("<html>To isolate for x, the 13 must be subbtracted, so in this case using the Subbtraction Property of Equality it will move 13 to the left side");
		lbltoIsolateFor.setForeground(Color.BLUE);
		lbltoIsolateFor.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lbltoIsolateFor.setBounds(656, 343, 381, 40);
		getContentPane().add(lbltoIsolateFor);
		
		JLabel lblSubbtractionPropertyOf_1 = new JLabel("<html>\r\nSUBBTRACTION PROPERTY OF EQUALITY : (x+13) - 13 = (39)-13");
		...
		lblSubbtractionPropertyOf_1.setBounds(655, 386, 357, 23);
		...
		lblSimplifyX_1.setBounds(656, 411, 318, 23);
		...
		lblMultiplucationPropertyOf.setBounds(255, 456, 249, 16);
		getContentPane().add(lblMultiplucationPropertyOf);
		
		JLabel lblwhenYouHave = new JLabel("<html>When you have fractions and you need to bring one variable out of the fraction or cancel some excess vairables the Multilpucation Property of Equality will come in handy\r\n");
		lblwhenYouHave.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lblwhenYouHave.setBounds(255, 472, 388, 64);
		...
		label_2.setBounds(255, 533, 318, 23);
		...
		lblGivenX_2.setBounds(255, 554, 318, 23);
		getContentPane().add(lblGivenX_2);
		
		JLabel lblsinceWeNeed_1 = new JLabel("<html>Since we need to get x by itself, we have to multiply by 3 to remain with only x");
		lblsinceWeNeed_1.setForeground(Color.BLUE);
		lblsinceWeNeed_1.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblsinceWeNeed_1.setBounds(255, 578, 381, 32);
		getContentPane().add(lblsinceWeNeed_1);
		
		JLabel lblMultiplucationPropertyOf_1 = new JLabel("<html>\r\nMULTIPLUCATION PROPERTY OF EQUALITY : 3*(x/3) = 3*(12)");
		...
		lblMultiplucationPropertyOf_1.setBounds(255, 613, 362, 23);
		...
		lblSimplifyX_2.setBounds(255, 638, 318, 23);
		...
		lblDivisionPropertyOf.setBounds(656, 456, 249, 16);
		getContentPane().add(lblDivisionPropertyOf);
		
		JLabel lblwhenYouAre = new JLabel("<html>When you are given a coeffecient and variable in an equation and you need to isolate for the variable, you need to do the opposite of multiply which is divide, Disivision Property of Equality\r\n");
		lblwhenYouAre.setFont(new Font("Times New Roman", Font.ITALIC, 13));
		lblwhenYouAre.setBounds(656, 472, 388, 64);
		...
		label_3.setBounds(656, 533, 318, 23);
		getContentPane().add(label_3);
		
		JLabel lblGivenx = new JLabel("<html>\r\nGIVEN : 3x=39");
		lblGivenx.setForeground(Color.BLUE);
		lblGivenx.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblGivenx.setBounds(655, 554, 318, 23);
		getContentPane().add(lblGivenx);
		
		JLabel lblsinceWeNeed_2 = new JLabel("<html>Since we need to get x by itself, we have to do the opposite of multiply which is divide and need to divide by 3, to get the x variable");
		lblsinceWeNeed_2.setForeground(Color.BLUE);
		lblsinceWeNeed_2.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblsinceWeNeed_2.setBounds(656, 578, 381, 32);
		...
		lblDivisionPropertyOf_1.setBounds(656, 613, 362, 23);
		...
		lblSimplifyX_3.setBounds(655, 638, 318, 23);
