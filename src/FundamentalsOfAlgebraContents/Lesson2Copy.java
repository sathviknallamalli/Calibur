	...
	public Lesson2Copy() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Lesson2PracticeProblemsCopy l2p = new Lesson2PracticeProblemsCopy();
				l2p.newClass();
				close();
		...
		JLabel lblto = new JLabel("<html>The Commutative property states that if you swap the order of the variable or numbers in an equation then the equation will still have the same output and theory.");
		lblto.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblto.setBounds(253, 237, 497, 32);
		...
		lblAssociativePropertyab.setBounds(253, 280, 249, 16);
		getContentPane().add(lblAssociativePropertyab);
		
		JLabel lbltheAssociativeProperty = new JLabel("<html>The Associative Property states that if you group numbers using parantheses differently in the same equation it will be the same and will not matter.");
		lbltheAssociativeProperty.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lbltheAssociativeProperty.setBounds(253, 307, 497, 32);
		getContentPane().add(lbltheAssociativeProperty);
		
		JLabel lblDescriptivePropertyAbc = new JLabel("Descriptive Property: a(b+c) = (a*b) + (a*c) = ab+ac");
		lblDescriptivePropertyAbc.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 14));
		lblDescriptivePropertyAbc.setBounds(253, 350, 313, 16);
		getContentPane().add(lblDescriptivePropertyAbc);
		
		JLabel lbltheAssociativeProperty_1 = new JLabel("<html>The Associative Property allows you to simplify equaions where something is getting multiplied by a parantheses set and states that you multiply anything outside of parantheses to inside the parantheses. ");
		lbltheAssociativeProperty_1.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lbltheAssociativeProperty_1.setBounds(253, 377, 497, 48);
		...
		lblExamples.setBounds(23, 440, 147, 23);
		...
		label.setBounds(21, 474, 232, 16);
		getContentPane().add(label);
		
		JLabel label_1 = new JLabel("<html>2*7 = 7*2 ==== 14 = 14");
		label_1.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		label_1.setBounds(21, 501, 127, 16);
		getContentPane().add(label_1);
		
		JLabel lblhoweverThisProperty = new JLabel("<html>HOWEVER, THIS PROPERTY DOES NOT APPLY TO DIVISION OR SUBBTRACTION HERE IS WHY:\r\n2/7 does not equal 7/2.\r\n7-2 does not equal 2-7.");
		lblhoweverThisProperty.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lblhoweverThisProperty.setBounds(21, 521, 681, 32);
		...
		lblhoweverThisProperty_1.setBounds(210, 602, 468, 23);
		...
		lblDescriptivePropertyAbc_1.setBounds(21, 641, 313, 16);
		...
		lbla.setBounds(21, 668, 183, 16);
		getContentPane().add(lbla);
		
		JLabel lbltheOutsideNumber = new JLabel("<html>THE OUTSIDE NUMBER WILL BE MULTIPLIES BY ALL CONTENTS OF PARANTHESES\r\n ");
		lbltheOutsideNumber.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		lbltheOutsideNumber.setBounds(210, 668, 492, 23);
