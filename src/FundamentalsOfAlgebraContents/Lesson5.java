...
public class Lesson5 extends JFrame {
	public Lesson5() {
		...
		JLabel lblaGoodWay = new JLabel("<html>A good way of remembering this method is by a memory trick that have the same abbretions but form a cool sentence thats easy to remember");
		...
		JLabel lblwhenAProbelm = new JLabel("<html>When a probelm requires you to substitute a value in for a variable, then you plug it in and solve. In order to simplify, when operations are in sequence, follow these categories in order and solve. Sometimes, when you have ONLY MULTIPLUCATION AND DIVISION or ONLY ADDITION AND SUBBTRACTIONS, you can solve from left to right. ");
