...
public class Lesson3Review extends JFrame {
	...
	public Lesson3Review() {
		...
		quizIntro.setBounds(176, 50, 558, 16);
		...
		JLabel lblWhatIs_1 = new JLabel("<html>4.) Which type of number would fit this scenario: How many pairs of pants do I have?");
		...
		btnNewButton.setBounds(384, 319, 109, 37);
