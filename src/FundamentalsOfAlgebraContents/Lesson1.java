...
public class Lesson1 extends JFrame {
	public Lesson1() {
		...
		JLabel lblinOrderFor = new JLabel("<html>In order for something to be classified as an equation you must need an equals sign, which justifies symmetry to an equation. It is generally composed of variables, coeffecients, and constants. The purpose of an equation is to solve for a variable. Below are some common formats of equations and what constituent is. The purpose of an equation is to solver a variable and isolate it and gain the numerical value for it. Equations are commonly used to represent general trends and to generalize data such as experimental, statistics, and historical data.\r\n");
		...
		JLabel lblEquationsCanHave = new JLabel("<html>Equations can have AS MANY VARIABLES as they want, however to solve them you need as many equations as there are variables which creates a system of equations. Equations with parantheses can be solved using the Distributive Property which we will discuss later in the chapter\r\n");
		...
		JLabel label_2 = new JLabel("<html>34 is also a CONSTANT that can be added,subtracted,multiplied,or divided to other constants \r\n");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Lesson1Review lr = new Lesson1Review();
				lr.newClass();
				close();
			}
		});
		...
		JLabel lblyouCannotAccess = new JLabel("<html>You cannot access this page during the review\r\n\r\n");
		lblyouCannotAccess.setFont(new Font("Times New Roman", Font.BOLD, 13));
		lblyouCannotAccess.setBounds(557, 360, 256, 16);
