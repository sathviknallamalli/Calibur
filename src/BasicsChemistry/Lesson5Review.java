...
public class Lesson5Review extends JFrame {
	...
	public Lesson5Review() {
		...
		bs.setBounds(701, 11, 160, 30);
		getContentPane().add(bs);

		boolean exists = TACALIBUR.startCourseVerify("Basics of Chemistry: Lesson 5 Review");
		if (exists == true) {
			TACALIBUR.scoreShow(bs, "Basics of Chemistry: Lesson 5 Review");
		}
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				next.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						TACALIBUR.lessonComplete("Basics of Chemistry: Lesson 5 Review", score);
